...
//waj program in which take two veriable num1 and num2 now swap the value of num1 and num 2 
//then increament the num2 value by 1them  decrement num2 value by 1.
